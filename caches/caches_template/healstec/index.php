  ...
  <div class="carousel-inner" role="listbox">
    ...
    <li data-target="#carousel-example-generic" data-slide-to="1"></li>
      ...
      <div class="item <?php if($n==1) { ?>active<?php } ?>">
          <a href="<?php echo $r['url'];?>" target="_blank"> <img src="<?php echo $r['thumb'];?>" alt="<?php echo $r['title'];?>" class="img-responsive">
			...
			<div class="row">
				...
				<ul class="col-md-12  col-sm-12 ">
                    ...
                    <li class="col-md-4 col-sm-4" id="li_o">
                        <span class="col-md-12 col-sm-12"<?php if($n==2) { ?>id="bor"<?php } ?>><img src="<?php echo $r['image'];?>" class="img-responsive center-block"/></span>
                        <h1><?php echo $r['description_index'];?></h1>
                        <h2 class="li_h<?php echo $n;?>"><a href="<?php echo $r['url'];?>"><?php echo $r['catname'];?></a></h2>
                    </li>
                    <?php $n++;}unset($n); ?>
                    <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
				</ul>
