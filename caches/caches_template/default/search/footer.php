...
<p class="cp">Powered by <strong><a href="http://www.healstec.com" target="_blank">PHPCMS</a></strong> v9 &copy; <?php echo date('Y', SYS_TIME);?> <img src="<?php echo IMG_PATH;?>copyright.gif"/>
</p></div>
      </div>
    </div>
<!--[if IE 6]>
